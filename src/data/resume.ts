...
export const resume: Record<Lang, ResumeContent> = {
  en: {
    about: {
      ...
      paragraphs: [
        "I'm an American IT professional living in Aomori, Japan. I came over in 2023 to teach on the JET Programme, but I never really stopped building. Websites and personal projects have been a constant the whole time, the way they have since I first got into computers. Now I'm moving back into tech full time, and I'm open across the board: IT support, infrastructure, and web development.",
        "Living and working day-to-day in Japanese (JLPT N2) means I'm used to picking things up quickly and explaining them clearly to people who don't share my background, which turns out to be most of the job. Outside of work you'll usually find me lifting or running, at one of my local clubs (ceramics, badminton, and dance), or buried in a side project: building mechanical keyboards, 3D printing, or writing up what I learn on the blog.",
      ],
    },
    experience: [
      {
